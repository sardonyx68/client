      ...
      <div class="row mb-2">
        <div class="col-12">
          <select class="form-select">
            ...
            <option value="1" selected> 노트북 </option>
      ...
      <div class="row">
        <div class="col-xl-3 col-lg-4 col-md-6" :key="i" v-for="(product,i) in productList">
          <div class="card" style="width:18rem;">
            <a @click="goToDetail(product.id);" style="cursor:pointer;"><img :src="`/download/${product.id}/${product.path}`" class="card-img-top" height="350"></a>
              <p></p> 
                  ...
                  <p class="card-text">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="btn-group" role="group">
                        ...
                        <a @click="goToDetail(product.id);"><button type="button" class="btn btn-sm btn-outline-secondary"> 주문하기 </button></a>
                      </div>
